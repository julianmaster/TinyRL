		...
		if(e instanceof ChangeRoomActionEvent) {
			...
			switch (direction) {
				case N:
					...
					door = (Door)nextRoom.getCell(new Pair<Integer, Integer>((Room.ROOM_SIZE - 1) / 2, Room.ROOM_SIZE - 1)).getEntity();
					break;
				...
				case S:
					...
					door = (Door)nextRoom.getCell(new Pair<Integer, Integer>((Room.ROOM_SIZE - 1) / 2, 0)).getEntity();
					break;
				...
				case E:
					...
					door = (Door)nextRoom.getCell(new Pair<Integer, Integer>(0, (Room.ROOM_SIZE - 1) / 2)).getEntity();
					break;
				...
				case W:
					...
					door = (Door)nextRoom.getCell(new Pair<Integer, Integer>(Room.ROOM_SIZE - 1, (Room.ROOM_SIZE - 1) / 2)).getEntity();
					break;
